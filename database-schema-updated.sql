...
CREATE TABLE Document (
    ...
    FOREIGN KEY (UploadedBy) REFERENCES UserDiagram(UserID) ON DELETE SET NULL,
    INDEX idx_section (SectionID),
...
-- Sample Courses
INSERT INTO Course (CourseCode, CourseName, CourseDescription, SubjectID) VALUES
('ENG 101', 'English I (Grade 9)', 'English Fundamentals for 9th Grade', @playsID),
('MATH 101', 'Math 101', 'Introductory Mathematics', NULL),
('ENG 120', 'Literature & Composition', 'Advanced Literature and Analysis', @playsID);
